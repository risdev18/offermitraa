...
import { Upload, Store, FileText, ChevronRight, Check, Phone, ShieldCheck } from "lucide-react";
...
export default function ShopSetup({ onComplete }: ShopSetupProps) {
    ...
    return (
        <div className="fixed inset-0 bg-[#020617]/95 backdrop-blur-3xl z-[100] overflow-y-auto">
            <div className="min-h-full w-full flex flex-col items-center justify-center p-4 py-12 gap-6 text-center">
                <motion.div
                    initial={{ scale: 0.95, opacity: 0 }}
                    animate={{ scale: 1, opacity: 1 }}
                    className="w-full max-w-lg bg-slate-900 border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl relative text-left"
                >
